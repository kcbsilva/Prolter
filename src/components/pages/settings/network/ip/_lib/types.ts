...
export interface IPBlock {
  id: string;
  version: IPVersion;
  cidr: string;           // e.g., "10.0.0.0/24" or "2001:db8::/48"
  description?: string;
  status: IPBlockStatus;
  createdAt: string;      // ISO
  updatedAt: string;      // ISO
  usedIPs?: number;       // how many addresses consumed (your app logic)
  totalStatic?: number;   // how many static addresses assigned (your app logic)
}
